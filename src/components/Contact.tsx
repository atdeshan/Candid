...
const contactMethods: ContactMethod[] = [
  {
    ...
    detail: 'info@candidevents.lk',
    link: 'mailto:info@candidevents.lk'
  },
  {
    id: 2,
    icon: '📞',
    title: 'Rumesh Chandrakumar',
    detail: '077 718 8485',
    link: 'tel:+94777188485'
  },
  // {
  //   id: 3,
  //   icon: '📧',
  //   title: 'Email Rumesh',
  //   detail: 'rumesh@candidevents.lk',
  //   link: 'mailto:rumesh@candidevents.lk'
  // },
  {
    id: 4,
    icon: '📞',
    title: 'Yasara Herath',
    detail: '070 390 0439',
    link: 'tel:+94703900439'
  },
  {
    id: 5,
    icon: '📧',
    title: 'Email Yasara',
    detail: 'yasara@candidevents.lk',
    link: 'mailto:yasara@candidevents.lk'
  }
];
    ...
    <div style={containerStyle} id="contact">
      ...
      <div className="contact-content">
        <div className="contact-grid">
          ...
          {/* Right Column - Social & Quick Info */}
          <div className="contact-additional-section">
            {/* Social Media Card */}
            <div className="social-card">
              <h3 className="section-title">Follow Our Journey</h3>
              <p className="section-description">
                Stay updated with our latest events and behind-the-scenes
              </p>
            ...
            <div className="quick-info-card">
              <h4 className="quick-info-title">Office Hours</h4>
